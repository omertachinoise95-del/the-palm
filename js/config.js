...
// ══════════════════════════════════════
// MENU DATA — articles avec stock
// ══════════════════════════════════════
const PARFUMS_HOOKAH = [
  'Menthe','Mi Amor','Hawai Love66','African Queen',
  'Menthe Sucree (+5EUR)','Water Melon (+5EUR)'
];

const MENU = [
  {id:'entrees',label:'ENTREES',title:'ENTREES',items:[
    {id:'bur',name:'BURRATA',desc:'Fromage italien, tomates, balsamiques',price:12},
    {id:'car',name:'CARPACCIO',desc:'Fines tranches de boeuf, parmesan (supp. Buratta 6EUR)',price:11},
  ...
  {id:'plats',label:'PLATS',title:'PLATS',sub:'SERVIS AVEC ACCOMPAGNEMENT AU CHOIX',
   extra:'SUPPLEMENT GARNITURE 5EUR — Frite maison, saute de legumes, puree maison',items:[
  ...
  {id:'desserts',label:'DESSERTS',title:'DESSERTS',items:[
    {id:'tro',name:'TROMPE LOEIL',desc:'Selon arrivage',price:12},
  ...
  {id:'mocktails',label:'MOCKTAILS',title:'MOCKTAILS',items:[
    ...
    {id:'cp',name:'COCO PINEAPPLE 50CL',desc:'Creme de coco, jus dananas, sucre de canne',price:10},
    {id:'ps',name:'PORN STAR 25CL',desc:'Jus de passion, jus dorange, sirop vanille',price:10},
  ...
  {id:'cocktails',label:'COCKTAILS',title:'COCKTAILS',items:[
    ...
    {id:'teq',name:'TEQUILA SUNRISE 30CL',desc:'Tequila 5cl, jus dorange, grenadine',price:12},
...
// Helper: tous les articles a plat
